...
var studioChatMb={
    ...
    formatContentHtml:function(data,isMeSend,isLoadData, isWh){
        ...
        if(content.msgType==studioChatMb.msgType.img){
            ...
            if(content.needMax){
                msgVal='<p><a href="/fxstudio/getBigImg?publishTime='+fromUser.publishTime+'&userId='+fromUser.userId+'" data-lightbox="' + lightboxArg + '"><img src="'+content.value+'" alt="图片"/></a></p>';
            }else{
    ...
    getUserAImgCls:function(userId, clientGroup,userType,avatar){
        ...
        return '<img src="/fx/theme2/img/'+aImgCls+'.png">';
    },
    /**
     * 离开房间提示
     */
