...
var chat={
    ...
    formatContentHtml:function(data,isMeSend,isLoadData){
        ...
        if(content.msgType==chat.msgType.img){
            if(content.needMax){
                pHtml='<a href="/fxstudio/getBigImg?publishTime='+fromUser.publishTime+'&userId='+fromUser.userId+'" data-lightbox="dialog-img"><img src="'+content.value+'" alt="图片"/></a>';
            }else{
    ...
    getAImgOrLevel:function(userId, clientGroup,userType,avatar){
        var retObj={aImg:common.isValid(avatar)?'<img src="'+avatar+'">':'<img src="/fx/theme1/img/user.png">',level:''};
    ...
    setWhContent:function(data,isMeSend,isLoadData,isOnlyFill){
        ...
        if(content.msgType==chat.msgType.img){
            if(content.needMax){
                pHtml='<p><i></i><a href="/fxstudio/getBigImg?publishTime='+fromUser.publishTime+'&userId='+fromUser.userId+'" data-lightbox="whImg-' + fromUser.toWhUserId + '"><img src="'+content.value+'" alt="图片"/></a></p>';
            }else{
