...
var chat={
    ...
    setWhContent:function(data,isMeSend,isLoadData,isOnlyFill){
        ...
        if(content.msgType==chat.msgType.img){
            if(content.needMax){
                pHtml='<a href="/fxstudio/getBigImg?publishTime='+fromUser.publishTime+'&userId='+fromUser.userId+'" data-lightbox="whimg-"' + fromUser.userId + '><img src="'+content.value+'" alt="图片"/></a>';
            }else{
