...
var studioMbPerson = {
    ...
    getUserLevelIco : function(clientGroup, avatar){
        ...
        var userLevelIco = "/fx/theme4/img/user_c.png";
        switch(clientGroup) {
            case "vip" :
                userLevelIco = "/fx/theme4/img/user_v.png";
                break;
            case "active" :
                userLevelIco = "/fx/theme4/img/user_r.png";
                break;
            case "notActive" :
                userLevelIco = "/fx/theme4/img/user_r.png";
                break;
            case "simulate" :
                userLevelIco = "/fx/theme4/img/user_d.png";
                break;
            case "register" :
                userLevelIco = "/fx/theme4/img/user_m.png";
                break;
        }
        return userLevelIco;
    },
