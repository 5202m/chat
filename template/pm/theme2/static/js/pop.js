...
var studioMbPerson = {
    ...
    getUserLevelIco : function(clientGroup, avatar){
        ...
        var userLevelIco = "/pm/theme2/img/user_c.png";
        switch(clientGroup) {
            case "vip" :
                userLevelIco = "/pm/theme2/img/user_v.png";
                break;
            case "active" :
                userLevelIco = "/pm/theme2/img/user_r.png";
                break;
            case "notActive" :
                userLevelIco = "/pm/theme2/img/user_r.png";
                break;
            case "simulate" :
                userLevelIco = "/pm/theme2/img/user_d.png";
                break;
            case "register" :
                userLevelIco = "/pm/theme2/img/user_m.png";
                break;
        }
        return userLevelIco;
    },
        ...
        $("#regForm_sub").bind("click", function(){
            ...
            common.getJson("/studio/reg",$("#regForm").serialize(),function(result){
                ...
                if(!result.isOK){
                    ...
                    $("#reg1Form_lpBtn").attr("href", "http://testweb1.24k.hk:8090/activity/live_luckydraw/index.html?userId=" + result.userId + "#ba");
...
var studioMbPwd1 = {
    ...
    setEvent : function(){
        $("#pwd1Form_sub").bind("click", function(){
            ...
            common.getJson("/studio/resetPwd",$("#pwd1Form").serialize(),function(result){
...
var studioMbPwd2 = {
    ...
    setEvent : function(){
        $("#pwd2Form_sub").bind("click", function(){
            ...
            common.getJson("/studio/resetPwd",$("#pwd2Form").serialize(),function(result){
...
var studioMbPwd3 = {
    ...
    setEvent : function(){
        $("#pwd3Form_sub").bind("click", function(){
            ...
            common.getJson("/studio/resetPwd",$("#pwd3Form").serialize(),function(result){
