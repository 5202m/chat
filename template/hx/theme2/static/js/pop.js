...
var studioMbPerson = {
    ...
    getUserLevelIco : function(clientGroup, avatar){
        ...
        var userLevelIco = "/hx/theme2/img/user_c.png";
        switch(clientGroup) {
            case "vip" :
                userLevelIco = "/hx/theme2/img/user_v.png";
                break;
            case "active" :
                userLevelIco = "/hx/theme2/img/user_r.png";
                break;
            case "notActive" :
                userLevelIco = "/hx/theme2/img/user_r.png";
                break;
            case "simulate" :
                userLevelIco = "/hx/theme2/img/user_d.png";
                break;
            case "register" :
                userLevelIco = "/hx/theme2/img/user_m.png";
                break;
        }
        return userLevelIco;
    },
