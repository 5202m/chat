...
var studioMbPerson = {
    ...
    load : function(userInfo, platform){
        if(userInfo && userInfo.isLogin){
            ...
            $(".logoutbtn").bind("click", platform, function(e){
                ...
                window.location.href="/fxstudio/logout?platform=" + e.data;
            });
        }
    },
    /**
    ...
    getUserLevelIco : function(clientGroup, avatar){
        ...
        var userLevelIco = "/images/fxstudio_mb/user_c.png";
        switch(clientGroup) {
            case "vip" :
                userLevelIco = "/images/fxstudio_mb/user_v.png";
                break;
            case "active" :
                userLevelIco = "/images/fxstudio_mb/user_r.png";
                break;
            case "notActive" :
                userLevelIco = "/images/fxstudio_mb/user_r.png";
                break;
            case "simulate" :
                userLevelIco = "/images/fxstudio_mb/user_d.png";
                break;
            case "register" :
                userLevelIco = "/images/fxstudio_mb/user_m.png";
                break;
        }
        return userLevelIco;
    },
            ...
            common.getJson("/fxstudio/login",$("#loginForm").serialize(),function(result){
                if(!result.isOK){
                    ...
                    if(studioMbLogin.groupId){
                        common.getJson("/fxstudio/checkGroupAuth",{redirectDef:1},function(result){
                            if(!result.isOK){
